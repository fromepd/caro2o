<template><!--店铺消费统计-->
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm"  :inline="true" v-show="showSearch">
      ...
      <el-form-item>
          <el-select  v-model="queryParams.dateStatus" placeholder="请选择查询类型">
            <el-option
       ...
       <el-form-item>
          <el-select  v-model="queryParams.serviceStatus" placeholder="请选择账单类型">
            <el-option
...
<script>
import {shopConsumption} from "@/api/report/report";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      shopConsumption(this.queryParams).then(response => {
