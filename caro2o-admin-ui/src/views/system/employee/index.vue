<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="是否超管" prop="admin">
        <el-select v-model="queryParams.admin" placeholder="请选择是否超管" clearable>
          <el-option
            v-for="dict in dict.type.sys_employee_admin"
            :key="dict.value"
            :label="dict.label"
            :value="dict.value"
          />
    ...
    <el-table v-loading="loading" :data="employeeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="是否超管" align="center" prop="admin">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.sys_employee_admin" :value="scope.row.admin"/>
        </template>
      </el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="是否超管" prop="admin">
          <el-select v-model="form.admin" placeholder="请选择是否超管">
            <el-option
              v-for="dict in dict.type.sys_employee_admin"
              :key="dict.value"
              :label="dict.label"
