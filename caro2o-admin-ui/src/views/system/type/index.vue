<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="typeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="车辆类型" align="center" prop="carName" />
      ...
      <el-table-column label="建议价格" align="center" prop="price" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="车辆类型" prop="carName">
          <el-input v-model="form.carName" placeholder="请输入车辆类型" />
        </el-form-item>
        <el-form-item label="车系" prop="carSeries">
        ...
        <el-form-item label="建议价格" prop="price">
          <el-input v-model="form.price" placeholder="请输入建议价格" />
        </el-form-item>
      </el-form>
